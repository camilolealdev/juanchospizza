...
- 170 files · ~560,750 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 1085 nodes · 1689 edges · 116 communities (81 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `f66985f7`
...
- `notifyOrderConfirmation()` --calls--> `sendTemplatedEmail()` [EXTRACTED]
  server/routes/orders.js → server/services/email.js
- `notifyOrderStatusChange()` --calls--> `sendTemplatedEmail()` [EXTRACTED]
  server/routes/orders.js → server/services/email.js
...
Cohesion: 0.07
Nodes (59): authenticate(), authMiddleware(), devSecretCache, generateSalt(), generateToken(), getSecret(), hashPin(), login() (+51 more)

### Community 1 - "helpers.js"

Cohesion: 0.16
Nodes (12): createExpenseSchema, updateExpenseSchema, bool(), clampedNumber(), clampedNumberOpt(), createIngredientSchema, updateIngredientSchema, createProductSchema (+4 more)
...
Cohesion: 0.06
Nodes (40): App(), AuthContext, AuthContextType, CajaView, ClientesView, ComandasView, ComprasView, EmpleadosView (+32 more)
...
Cohesion: 0.07
Nodes (33): CartItem, CashFlow, CashRegisterEntry, Comanda, ComandaItem, Combo, CreditNote, DiningTable (+25 more)
...
Cohesion: 0.18
Nodes (9): Campaign, LoyaltyReward, OrderStatus, emptyForm, ApiOrder, groupOptions, normalizeOrder(), ReportesView() (+1 more)
...
Cohesion: 0.12
Nodes (20): initPush(), sendPushToPhone(), computeNivel(), notifyOrderConfirmation(), notifyOrderStatusChange(), notifyWebhook(), router, updateClientSpendAggregate() (+12 more)
...
Cohesion: 0.09
Nodes (21): API Documentation — Juancho's Pizza / GastroPro, 🔐 Auth, 📂 Categories, ⚠️ Códigos de Error, `GET /api/categories`, `GET /api/health`, `GET /api/menu`, `GET /api/payments/status` (+13 more)
...
Cohesion: 0.18
Nodes (10): createCategorySchema, updateCategorySchema, str(), strOpt(), createPaymentSchema, createPurchaseOrderSchema, createQrMenuConfigSchema, purchaseItemSchema (+2 more)
...
Cohesion: 0.21
Nodes (8): strDefault(), createInventoryItemSchema, inventoryMovementSchema, updateInventoryItemSchema, itemsField, LOCATION_IDS, closeShiftSchema, openShiftSchema
...
Cohesion: 0.27
Nodes (9): createEmployeeSchema, LOCATIONS, ROLES, setPasswordSchema, updateEmployeeSchema, passwordBase(), passwordRequired(), passwordSecure() (+1 more)

### Community 85 - "helpers.test.js"

Cohesion: 0.18
Nodes (8): clampedNumberDefaultOnUndef(), requiredPositiveNumber(), createCreditNoteSchema, createInvoiceSchema, updateInvoiceSchema, addPointsSchema, createRewardSchema, updateRewardSchema

### Community 86 - "websocket.js"

Cohesion: 0.31
Nodes (9): allConnections, broadcast(), broadcastToRole(), connections, initWebSocket(), notifyComandaUpdate(), notifyNewOrder(), notifyOrderUpdate() (+1 more)
...
Cohesion: 0.20
Nodes (8): createClientSchema, ESTADOS, patchClientSchema, updateClientSchema, boolOpt(), batchUpdateStatusSchema, createTableSchema, updateTableSchema

### Community 89 - "useWebSocket.ts"

Cohesion: 0.33
Nodes (9): connect(), disconnect(), globalListeners, reconnectWS(), scheduleReconnect(), subscribeWS(), useWebSocket(), WSEvent (+1 more)
...
- **505 isolated node(s):** `husky.sh script`, `husky.sh script`, `semi`, `singleQuote`, `trailingComma` (+500 more)
...
- **Should `index.js` be split into smaller, more focused modules?**
  _Cohesion score 0.06710526315789474 - nodes in this community are weakly interconnected._
