...
router.post('/api/consent', validate(postConsentSchema), async (req, res) => {
  try {
    ...
    console.error('[Habeas Data] POST /api/consent failed:', e.message);
...
router.post('/api/derecho/:tipo', async (req, res) => {
  ...
  try {
    ...
    console.error('[Habeas Data] POST /api/derecho/:tipo failed:', e.message);
