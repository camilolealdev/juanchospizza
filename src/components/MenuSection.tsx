    ...
    <section id="menu" className="relative bg-gradient-to-b from-crema via-crema to-crema/95 py-12 sm:py-16 md:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-carbon mb-4">Nuestro Menú</h2>
    ...
    <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden flex flex-col">
      ...
      <div className="p-5 flex flex-col flex-1">
        <div className="flex-1">
          ...
          {item.description && (
            <p className="text-xs text-carbon/50 line-clamp-2 leading-relaxed">{item.description}</p>
          )}
        </div>
        ...
        <div className="flex items-end justify-between mt-4 pt-3 border-t border-carbon/5">
          <div>
            ...
            {item.priceCombo && (
              <p className="text-[11px] text-albahaca font-medium">Combo: {formatPrice(item.priceCombo)}</p>
            )}
          </div>
          <button
