...
const CartDrawer: React.FC<CartDrawerProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-carbon/10">
          <div>
            <h2 className="font-heading text-2xl sm:text-3xl text-carbon">Tu Pedido</h2>
                ...
                <div key={item.id} className="bg-white rounded-xl p-4 shadow-sm">
                  <div className="flex justify-between items-start mb-2">
                    <div className="flex-1 min-w-0">
                      ...
                      {item.details && <p className="text-carbon/50 text-xs sm:text-sm truncate">{item.details}</p>}
        ...
        {/* Footer */}
        {items.length > 0 && (
          <div className="sticky bottom-0 bg-crema border-t border-carbon/10 px-4 sm:px-6 py-3 sm:py-4 space-y-2 sm:space-y-3">
            ...
            <button
              onClick={handleOrder}
              className="w-full bg-green-600 text-white font-heading text-base sm:text-xl py-3 rounded-xl flex items-center justify-center gap-2 hover:bg-green-700 transition-colors"
            >
