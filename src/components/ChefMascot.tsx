...
const ChefMascot: React.FC<ChefMascotProps> = ({ selectedFlavors, flavorIcons, flavorNames }) => {
  ...
  return (
    <svg viewBox="0 0 400 520" className="w-full h-full drop-shadow-2xl">
      ...
      <g>
        <text x="25" y="50" fontSize="24" opacity="0.18" className="float-slice float-slice-1">🍕</text>
        <text x="350" y="60" fontSize="18" opacity="0.14" className="float-slice float-slice-2">🍕</text>
        <text x="15" y="440" fontSize="16" opacity="0.1" className="float-slice float-slice-3">🍕</text>
        <text x="365" y="400" fontSize="20" opacity="0.15" className="float-slice float-slice-4">🍕</text>
      </g>

      {/* Sparkles */}
      <g filter="url(#sparkle-blur)">
        <text x="45" y="110" fontSize="14" className="sparkle-pulse sparkle-pulse-1">✨</text>
        <text x="345" y="130" fontSize="11" className="sparkle-pulse sparkle-pulse-2">✨</text>
        <text x="35" y="320" fontSize="12" className="sparkle-pulse sparkle-pulse-3">✨</text>
        <text x="360" y="310" fontSize="10" className="sparkle-pulse sparkle-pulse-4">⭐</text>
        <text x="60" y="220" fontSize="9" className="sparkle-pulse sparkle-pulse-5">✨</text>
      </g>
      ...
      <g className="chef-bob" style={{ transformOrigin: '200px 260px', transform: 'scale(1.08)' }}>
        ...
        <g filter="url(#chef-glow)">
          <path d="M140 290 Q140 270 162 262 L238 262 Q260 270 260 290 L260 390 Q260 402 248 402 L152 402 Q140 402 140 390 Z" fill="url(#overalls-gradient)" />
          {/* Golden double stitching */}
          <path d="M144 292 Q144 274 164 266 L236 266 Q256 274 256 292 L256 388 Q256 398 246 398 L154 398 Q144 398 144 388 Z" fill="none" stroke="#D4A040" strokeWidth="1" strokeDasharray="3 3" opacity="0.45" />
          {/* Overall straps */}
          <path d="M162 262 L168 222 Q170 214 178 214 L222 214 Q230 214 232 222 L238 262" fill="none" stroke="url(#overalls-gradient)" strokeWidth="14" strokeLinecap="round" />
          {/* Brass hardware */}
          ...
          <rect x="175" y="308" width="50" height="36" rx="4" fill="none" stroke="#D4A040" strokeWidth="0.5" strokeDasharray="2 3" opacity="0.35" />
          {/* Circular patch */}
        ...
        <g>
          ...
          {/* Shirt pocket */}
          <rect x="210" y="232" width="18" height="14" rx="2" fill="none" stroke="#94B8D0" strokeWidth="0.8" opacity="0.4" />
          ...
          {/* Left arm */}
          <path d="M128 242 Q100 268 92 305 Q88 320 96 328" fill="none" stroke="url(#shirt-gradient)" strokeWidth="26" strokeLinecap="round" />
          ...
          <path d="M80 324 Q74 320 72 326 Q70 332 76 336 Q82 338 86 334" fill="#7A5535" stroke="#5C4033" strokeWidth="1" />
          <path d="M78 332 Q72 330 70 336 Q70 342 76 344 Q82 344 86 340" fill="#7A5535" stroke="#5C4033" strokeWidth="1" />
          <path d="M80 338 Q76 340 74 344 Q74 350 80 350 Q86 348 88 344" fill="#7A5535" stroke="#5C4033" strokeWidth="1" />
          {/* Thumb */}
          <path d="M100 322 Q106 318 108 324 Q108 330 102 332" fill="#7A5535" stroke="#5C4033" strokeWidth="1" />
          {/* Glove stitching */}
          <path d="M84 328 Q92 336 104 330" fill="none" stroke="#D4A040" strokeWidth="0.7" strokeDasharray="2 2" opacity="0.6" />
          <path d="M86 322 Q90 318 98 320" fill="none" stroke="#D4A040" strokeWidth="0.5" strokeDasharray="1.5 2" opacity="0.4" />
          {/* Knuckle creases */}
          ...
          {/* Right arm */}
          <path d="M272 242 Q300 268 308 300 Q312 315 304 322" fill="none" stroke="url(#shirt-gradient)" strokeWidth="26" strokeLinecap="round" />
          {/* Right glove with fingers gripping peel */}
          <ellipse cx="308" cy="324" rx="18" ry="15" fill="url(#glove-gradient)" />
          {/* Fingers wrapping around handle */}
          <path d="M320 318 Q326 314 328 320 Q330 326 324 330 Q318 332 314 328" fill="#7A5535" stroke="#5C4033" strokeWidth="1" />
          <path d="M322 326 Q328 324 330 330 Q330 336 324 338 Q318 338 314 334" fill="#7A5535" stroke="#5C4033" strokeWidth="1" />
          <path d="M320 334 Q324 336 326 340 Q326 346 320 346 Q314 344 312 340" fill="#7A5535" stroke="#5C4033" strokeWidth="1" />
          {/* Thumb */}
          <path d="M300 316 Q294 312 292 318 Q292 324 298 326" fill="#7A5535" stroke="#5C4033" strokeWidth="1" />
          {/* Glove stitching */}
          <path d="M316 322 Q308 330 296 324" fill="none" stroke="#D4A040" strokeWidth="0.7" strokeDasharray="2 2" opacity="0.6" />
          <path d="M314 316 Q310 312 302 314" fill="none" stroke="#D4A040" strokeWidth="0.5" strokeDasharray="1.5 2" opacity="0.4" />
          {/* Knuckle creases */}
        ...
        <g filter="url(#peel-shadow)">
          {/* Handle */}
          <rect x="290" y="268" width="10" height="125" rx="5" fill="url(#peel-handle)" transform="rotate(12 295 330)" />
          <ellipse cx="310" cy="348" rx="6" ry="3" fill="none" stroke="#5C4033" strokeWidth="1" opacity="0.3" transform="rotate(12 310 348)" />
          <ellipse cx="314" cy="358" rx="6" ry="3" fill="none" stroke="#5C4033" strokeWidth="1" opacity="0.3" transform="rotate(12 314 358)" />
          ...
          <ellipse cx={peelCx} cy={peelCy} rx="96" ry="88" fill="none" stroke="#7A5535" strokeWidth="0.4" opacity="0.15" />
          ...
          {flavorIds.length > 0 && (
            <circle cx={peelCx} cy={peelCy} r={pizzaR - 10} fill="#C62828" opacity={0.1} />
          )}

          {/* Empty state */}
          {flavorIds.length === 0 && (
            <g>
              <text x={peelCx} y={peelCy - 6} textAnchor="middle" fill="#8B572A" fontSize="9" fontWeight="700" opacity="0.7" fontFamily="sans-serif">
                ¡Empieza a elegir!
              </text>
          ...
          {flavorIds.length === 1 && (
            <>
              ...
              {flavorIcons[flavorIds[0]] && (
                <text x={peelCx} y={peelCy + 2} textAnchor="middle" dominantBaseline="central" fontSize="26" opacity={0.85}>
                  {flavorIcons[flavorIds[0]]}
                </text>
              )}
            </>
          ...
          {flavorIds.length === 2 &&
            flavorIds.map((fId, i) => {
              ...
              return (
                <g key={fId}>
                  <path d={describeArc(peelCx, peelCy, pizzaR - 6, startAngle, endAngle)} fill={SLICE_COLORS[i]} opacity={0.25} stroke="#8B572A" strokeWidth={0.6} />
                  {flavorIcons[fId] && (
                    <text x={lx} y={ly} textAnchor="middle" dominantBaseline="central" fontSize="17" opacity={0.85}>
                      {flavorIcons[fId]}
                    </text>
                  )}
                  <text x={lx} y={ly + 14} textAnchor="middle" fill="#5C1212" fontSize="5.5" fontWeight="600" opacity={0.7} fontFamily="sans-serif">
                    {flavor}
                  </text>
                </g>
              );
            ...
            flavorIds.map((fId, i) => {
              ...
              return (
                <g key={fId}>
                  ...
                  <text x={lx} y={ly + 12} textAnchor="middle" fill="#5C1212" fontSize="5" fontWeight="600" opacity={0.7} fontFamily="sans-serif">
                    {flavor}
                  </text>
                </g>
              );
          ...
          <circle cx={peelCx} cy={peelCy} r={pizzaR + 2} fill="none" stroke="#D2B48C" strokeWidth={0.6} strokeDasharray="4 3" opacity={0.3} />
        </g>
        ...
        <g filter="url(#head-shadow)">
          ...
          {/* Hair - dense wavy */}
          <g>
            <path d="M148 126 Q148 84 172 76 Q188 72 200 78 Q212 72 228 76 Q252 84 252 126 Q248 104 232 102 Q218 100 200 106 Q182 100 168 102 Q152 104 148 126" fill="#3D2B1F" />
            <path d="M152 116 Q156 102 164 110 Q172 102 178 108" fill="none" stroke="#2A1E15" strokeWidth="1.8" opacity="0.4" />
            <path d="M190 104 Q196 96 202 104 Q208 96 214 102" fill="none" stroke="#2A1E15" strokeWidth="1.5" opacity="0.35" />
            <path d="M222 108 Q228 100 236 108 Q240 102 244 110" fill="none" stroke="#2A1E15" strokeWidth="1.5" opacity="0.3" />
          ...
          <g>
            ...
            <path d="M170 186 Q176 174 200 178 Q224 174 230 186 Q236 196 228 202 Q220 196 200 200 Q180 196 172 202 Q164 196 170 186 Z" fill="#3D2B1F" />
            {/* Highlight streak */}
            <path d="M178 188 Q190 180 200 182 Q210 180 222 188" fill="none" stroke="#5C4033" strokeWidth="1" opacity="0.35" />
            {/* Left curl - spiraling outward */}
            <path d="M170 200 Q162 206 160 214 Q160 220 166 222 Q172 222 174 216" fill="none" stroke="#3D2B1F" strokeWidth="3" strokeLinecap="round" />
            <path d="M164 220 Q160 226 164 228" fill="none" stroke="#3D2B1F" strokeWidth="2.5" strokeLinecap="round" />
            {/* Right curl - spiraling outward */}
            <path d="M230 200 Q238 206 240 214 Q240 220 234 222 Q228 222 226 216" fill="none" stroke="#3D2B1F" strokeWidth="3" strokeLinecap="round" />
          ...
          <text x="156" y="184" fontSize="7" opacity="0.22" fill="#E06060">♥</text>
          <text x="236" y="184" fontSize="7" opacity="0.22" fill="#E06060">♥</text>
        </g>
      </g>
    </svg>
  );
