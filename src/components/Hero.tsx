    ...
    <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden w-full max-w-full">
      ...
      <div className="relative z-10 text-center px-5 max-w-4xl mx-auto">
        ...
        <h1 className="font-heading text-5xl sm:text-6xl md:text-8xl lg:text-9xl leading-none mb-4 sm:mb-6 uppercase tracking-wider">
          <span className="text-crema drop-shadow-[0_4px_24px_rgba(0,0,0,0.95)]">El Sabor Que </span>
          <span className="text-queso drop-shadow-[0_4px_24px_rgba(0,0,0,0.95)]">No Tiene Igual</span>
        </h1>
