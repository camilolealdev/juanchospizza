...
> **Documento histórico:** conservar como resumen de una ejecución anterior. Para el estado vigente usar `docs/DEPLOY_CHECKLIST.md`, `docs/PENDIENTES_OPERACIONALES_2026-08-17.md` y `.github/workflows/deploy-prod.yml`. Las cifras y el commit indicados abajo no son un estado actual garantizado.
...
```bash
curl https://juanchospizza.com/api/health   # → {"status":"healthy", ...}
curl https://juanchospizza.com/api/metrics  # → métricas Prometheus
```
